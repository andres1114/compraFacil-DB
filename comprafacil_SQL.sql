...
CREATE TABLE empleado (
	...
	telefono_fijo_empleado VARCHAR(255) NOT NULL,
	telefono_celular_empleado VARCHAR(255) NOT NULL,
	direccion_residencia_empleado VARCHAR(255) NOT NULL,
...
CREATE TABLE proveedor (
	id INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
	id_tipo_identificacion VARCHAR(255) NOT NULL,
	numero_identificacion_proveedor VARCHAR(255) NOT NULL,
